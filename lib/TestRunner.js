...
pipeline([
    ...
    function safetyChecks() {
        return when(
            ...
            function() {
                console.log('[TestRunner] Grid is available, and it has all needed browsers');
            },
    ...
    function startServer() {
        return when(
            ...
            function() {
                console.log('[TestRunner] Server started');
            },
    ...
    function shutdown() {
        ...
        webdrivers.forEach(function captureBrowser(webdriver) {
            if (webdriver.isAvailable()) {
                console.log('[TestRunner] About to quit the browser instance');
